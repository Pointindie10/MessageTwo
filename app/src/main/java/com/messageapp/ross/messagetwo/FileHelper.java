...
public class FileHelper {
	...
	public static byte[] getByteArrayFromFile(Context context, Uri uri)
    {
        ...
        if (uri.getScheme().equals("content")) //getting content
        {
        	try
            {
	        ...
	        finally
            {
                ...
                {
	        		inStream.close();
	        		outStream.close();//closing the streams
	        	}
	        	catch (IOException e) { /**/ }
	        }
        }
	...
	public static String getFileName(Context context, Uri uri, String fileType)
    {
		...
		if (fileType.equals(ParseConstants.TYPE_IMAGE))
        {
			fileName += "png";
                ...
                {
			        // file extension required for videos
			        if (uri.getScheme().equals("content"))
                    {
                        ...
                        {
				            fileName = uri.getLastPathSegment();//directing the filename
			            }
		}
